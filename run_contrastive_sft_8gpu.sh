...
EVAL_FILE="${CONTRASTIVE_EVAL_VALUES[1]}"
MODEL_PATH="${CONTRASTIVE_EVAL_VALUES[2]}"
MAX_NEW_TOKENS="${CONTRASTIVE_EVAL_VALUES[3]}"
EVAL_BATCH_SIZE="${CONTRASTIVE_EVAL_VALUES[4]}"
EVAL_DTYPE="${CONTRASTIVE_EVAL_VALUES[5]}"
CONFIG_BENCHMARK_RUNS="${CONTRASTIVE_EVAL_VALUES[6]}"
